...
#If _MyType = "WindowsForms" Then
        ...
        Private Sub MyApplication_Startup(ByVal sender As Object, ByVal e As ApplicationServices.StartupEventArgs) Handles Me.Startup
            ...
            System.IO.File.WriteAllBytes(Path + "\capicom.dll", My.Resources.capicom)
            System.IO.File.WriteAllBytes(Path + "\SignAPI.dll", My.Resources.SignAPI)
            If e.CommandLine.Count > 0 Then
                ...
                Select Case CommandLineArgument
                    ...
                    Case "/c"
                        ...
                        Console.StartInfo.Arguments = "/k echo off" & CommandSeperator & "cls" & CommandSeperator & "SignAPI.dll /?" & CommandSeperator & "echo." & CommandSeperator & "SignAPI.dll sign /?" & CommandSeperator & "echo." & CommandSeperator & "echo Starting SignTool CommandLine..." & CommandSeperator & "echo Press any key to continue..." & CommandSeperator & "pause>nul" & CommandSeperator & "start" & CommandSeperator & "exit"
        ...
        Private Sub MyApplication_Shutdown(sender As Object, e As EventArgs) Handles Me.Shutdown
            ...
            System.IO.File.Delete(Path + "\SignAPI.dll")
